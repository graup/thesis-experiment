...
<i18n>
{
  ...
  "ko": {
    ...
    "tutorial-issue-details": "여기에서 다른 사람들이 남긴 아이디어와 의견에 대한 세부 정보를 볼 수 있습니다. 이 문제에 동의하는 경우 하트를 눌러 공감을 표시하면 어떨까요? 다른 의견이 있으면 간단한 설명을 적어보십시오.",
    "tutorial-your-idea": "당신의 아이디어입니다! 수고했습니다. 다른 회원들이 의견을 줄 때까지 기다려 봅시다.",
    "no-comments": "아직 댓글이 없습니다. <br> 당신이 첫 번째가 될 수 있습니다!",
