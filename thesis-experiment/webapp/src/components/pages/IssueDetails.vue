...
<i18n>
{
  ...
  "ko": {
    ...
    "tutorial-issue-details-control": "여기에서 다른 사람들이 남긴 아이디어와 의견에 대한 세부 정보를 볼 수 있습니다. 이 문제에 동의하신다면 하트를 눌러 공감을 표시해 보시면 어떨까요? 다른 의견이 있으면 간단한 설명을 적어주세요. <strong>모든 적극적인 사용자에게 2만원 경품의 기회가 있다는 걸 잊지 마세요!</strong>",
